...
class Config:
    ...
    STACK_NAME = os.environ.get("STACK_NAME", "StudentFeedback")
    ...
    CUSTOM_HEADER_VALUE = os.environ.get("CUSTOM_HEADER_VALUE", "My_random_value_58dsvasdaswcd5e4s31")
    ...
    SECRETS_MANAGER_ID = os.environ.get("SECRETS_MANAGER_ID", f"{STACK_NAME}ParamCognitoSecret12345")
    ...
    # Custom header name used for ALB security
    CUSTOM_HEADER_NAME = os.environ.get("CUSTOM_HEADER_NAME", "X-Custom-Header")
